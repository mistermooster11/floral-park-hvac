      ...
      <div className="faq__container">
        ...
        <div className="faq__left">
          ...
          <h2 className="faq__heading">
            Know More About Our HVAC Services in Nassau County &amp; Western Suffolk
          </h2>
          <p className="faq__subtext">
            Find clear answers about our residential and commercial heating, cooling, and air
            quality services — including emergency response and seasonal maintenance — across
            Nassau County and the surrounding areas.
          </p>
