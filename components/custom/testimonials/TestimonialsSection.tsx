    ...
    <section className="testimonials" ref={sectionRef}>
      <div className="testimonials__container">
        ...
        <div className="testimonials__header">
          <div className="testimonials__eyebrow">Honest. Fast. Local.</div>
          <h2 className="testimonials__heading">Trusted When It Matters Most</h2>
          <p className="testimonials__subtext">
            Our clients rely on Floral Park HVAC for fast response, professional service, and
            dependable heating and cooling solutions for residential and commercial properties
            across Nassau County and Western Suffolk.
          </p>
        </div>
