    ...
    <section className="need-services" ref={sectionRef}>
      <div className="need-services__inner">
        ...
        <p className="need-services__text">
          Request fast, professional AC repair, furnace repair, or HVAC maintenance —
          same-day service available across Nassau County, Western Suffolk, and Northern Queens.
        </p>
        <a href="tel:+15168554328" className="need-services__btn">
          Call (516) 855-4328
        </a>
      </div>
    </section>
