      ...
      <div className="about__container">
        ...
        <div className="about__content">
          ...
          <h2 className="about__heading">
            Trusted HVAC Services Across Nassau County
            &amp; Long Island
          </h2>
          <p className="about__text">
            Floral Park HVAC is a licensed, insured, and bonded HVAC contractor
            serving Nassau County, Western Suffolk, and Northern Queens. We install,
            service, and repair air conditioning systems, heating units, boilers, and
            water heaters — with honest pricing and fast response, every time.
          </p>
          <p className="about__text">
            We hold a Nassau County Home Improvement Contractor license and our
            BuildZoom score of 94 places us in the top 24% of licensed New York
            contractors. When a professional comes to your home, you deserve
        ...
        <div className="about__media">
          <div className="about__img-wrap">
            <Image
              src="/images/hvac-technician-installing-ductwork-attic.jpg"
              alt="Floral Park HVAC technician installing ductwork"
              width={690}
              height={613}
