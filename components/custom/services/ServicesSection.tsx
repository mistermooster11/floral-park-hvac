    ...
    <section className="services" ref={sectionRef}>
      ...
      <div className="services__header max-w-6xl! mx-auto">
        ...
        <h2 className="services__heading">
          Professional HVAC Services in Nassau County &amp; Western Suffolk
        </h2>
        <p className="services__subtext">
          Reliable residential and commercial heating and cooling services designed to keep your
          home or business comfortable year-round across Nassau County and the surrounding areas.
        </p>
      </div>
