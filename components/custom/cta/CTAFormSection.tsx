...
export default function CTAFormSection() {
  ...
  const WHY_LEFT = [
    ...
    "Nassau County & Long Island service",
    "Same-day appointments available",
  ];
  const WHY_RIGHT = [
    "All major HVAC brands serviced",
    "AC repair, furnace repair & more",
    "Honest diagnosis, no upselling",
    "Fast, reliable, professional team",
  ];
    ...
    <section className="cta-form" ref={sectionRef}>
      <div className="cta-form__container">
        ...
        <div className="cta-form__left p-10!">
          <div className="cta-form__eyebrow hidden md:block">Mon–Fri 7am–5pm · Sat 7am–1pm</div>
          ...
          <p className="cta-form__subtext hidden md:block">
            Serving Nassau County, Western Suffolk &amp; Northern Queens
            <br />— honest pricing, fast scheduling
          </p>
        ...
        <div className="cta-form__right">
          ...
          <p className="cta-form__text">
            Fast-response HVAC repair and maintenance services available across Nassau County,
            Western Suffolk, and Northern Queens. Same-day service available — call
            (516) 855-4328 or fill out the form and we&apos;ll get back to you quickly.
          </p>
          <p className="cta-form__text">
            We also offer annual maintenance plans to keep your system running efficiently
            year-round — catching small issues before they become expensive repairs, and
